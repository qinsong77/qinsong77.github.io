...
<span class="line"><span>I&#39;ll fix these tests without changing the scene</span></span></code></pre></div><h2 id="cursor" tabindex="-1">Cursor <a class="header-anchor" href="#cursor" aria-label="Permalink to &quot;Cursor&quot;">​</a></h2><ul><li><a href="https://cursor.directory/" target="_blank" rel="noreferrer">cursor</a></li><li><a href="https://cursor.fan/tutorial/Tutorial/10x-your-productivity/" target="_blank" rel="noreferrer">10x Your Productivity: Secret Cursor AI Techniques I Learned from Building Real Projects</a></li></ul>`,12)])])}const m=a(i,[["render",l]]);export{u as __pageData,m as default};
